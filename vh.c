...
int main() {
    float balance=88888888, outstanding_debt=0, account=868686, money; // So Du , Du No , Tai Khoan , Tien
    int c, cach;

    do {
        printf("\n=== MENU NGAN HANG MB BANK ===\n");
        ...
        switch(c){
            ...
            case 3: printf("Withdraw money: "); // Rut Tien
			scanf("%f",&money);
            ...
            case 4: printf("Transfer money: "); // Chuyen Tien
			scanf("%f",&money); 
